...
zstyle ':completion:*::::' completer \
       expand _complete _ignored _approximate
...
#+BEGIN_SRC nix
  manpages = buildEnv {
    ...
    paths = userPackages ++ [posix_man_pages]
      ++ stdenv.lib.optional (stdenv.isDarwin && isBig)
...
#+BEGIN_SRC nix
  sysframeworks = buildEnv {
    name = "frameworks";
    paths = stdenv.lib.optional (stdenv.isDarwin && isBig)
                                 darwin.apple_sdk.sdk;
  };
#+END_SRC
...
Setup global environment variables and directories. Most of the global
...
#+BEGIN_SRC nix
  ...
  PATH = lib.concatStringsSep ":" [
           (lib.makeBinPath ([ bins myEmacs zsh ] ++ global-dirs))
  ...
  XDG_DATA_DIRS = lib.makeSearchPathOutput "xdg" "share"
    ([ xdg-data myEmacs zsh ] ++ global-dirs);
#+END_SRC
