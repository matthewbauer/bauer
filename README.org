...
#+BEGIN_SRC emacs-lisp
  (set-defaults
   ...
   '(sys-headers "@sysheaders@/include")
   '(Man-header-file-path
     `(,sys-headers "/usr/include" "/usr/local/include"))
   '(ffap-c-path `(,sys-headers "/usr/include" "/usr/local/include"))
...
#+BEGIN_SRC nix
  site-paths = runCommand "site-paths.el" {
    ...
    inherit manpages sysheaders schemas;
...
manpages = buildEnv {
  name = "man-pages";
  paths = [posix_man_pages man-pages]; # stdmanpages
};
