...
** HACK Autoloads
  ...
  For some reason, package developers have forgotten to autoload these function,
  so we can just define them here.

  #+BEGIN_SRC
(autoload 'use-package-autoload-keymap "use-package")
(autoload 'tramp-tramp-file-p "tramp")
(autoload 'org-define-error "org")
(autoload 'org-link-types "org")
(autolaod eshell-rebind-keys-alist "eshell")
  #+END_SRC
...
language: nix
  ...
  #+BEGIN_SRC yaml
script: nix-build --argstr nixpkgs-url $NIXPKGS
  #+END_SRC
