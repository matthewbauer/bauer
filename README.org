...
#+BEGIN_SRC emacs-lisp
  ...
  (eval-and-compile
    ...
    (autoload 'sp-local-pair "smartparens" "" nil nil)
    (autoload 'sp-local-tag  "smartparens" "" nil nil)

    (autoload 'projectile-project-vcs "projectile" "" nil nil)
    (autoload 'pcomplete-arg   "pcomplete" "" nil nil)
    (autoload 'pcomplete--here "pcomplete" "" nil nil)

    ;; (autoload 'comint-write-input-ring "comint" "" nil nil)
    ;; (autoload 'ansi-color-process-output "ansi-color" "" nil nil)
    ;; (autoload 'dired-get-filename "dired" "" nil nil)
    ;; (autoload 'locate-file "files" "" nil nil)
    ;; (autoload 'file-remote-p "files" "" nil nil)
    ;; (autoload 'tramp-tramp-file-p        "tramp" "" nil nil)
    ;; (autoload 'tramp-file-name-method    "tramp" "" nil nil)
    ;; (autoload 'tramp-file-name-host      "tramp" "" nil nil)
    ;; (autoload 'tramp-file-name-localname "tramp" "" nil nil)
    )
...
#+BEGIN_SRC emacs-lisp
  (eval-and-compile
    ...
    (advice-add 'use-package-normalize-binder :override 'use-package-normalize-binder-override)
    )
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package irony
    ...
    (defun irony-mode-disable-remote ()
      ...
      (when (or buffer-file-name (file-remote-p buffer-file-name))
        (irony-mode -1)))
