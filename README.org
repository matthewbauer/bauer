...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package cape
    :after corfu
    :commands (cape-file cape-dabbrev cape-dict cape-elisp-block)
    :preface
  ...
  (use-package consult
    :autoload (consult-register-window consult-register-format consult-xref)
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package magit
    ...
    (autoload #'magit-commit-diff "magit-commit")
...
#+BEGIN_SRC emacs-lisp
  (use-package org
    ...
    :preface
    (autoload #'pcomplete-completions-at-point "pcomplete")
