...
(eval-when-compile (autoload 'use-package-autoload-keymap "use-package"))
   #+END_SRC
** Custom config
...
** Setup use-package
   ...
   step. This block is currently broken.
...
** =default.nix=
   ...
   #+BEGIN_SRC nix
{ nixpkgs-url ? "nixos.org/channels/nixpkgs-17.09-darwin"
