...
#+BEGIN_SRC nix
  ...
  in pkgs'.emacsPackagesFor (pkgs'.emacsGcc.overrideAttrs (o: {
    patches = (o.patches or []) ++ [ (pkgs.fetchpatch {
      url = "https://github.com/matthewbauer/emacs/commit/32022ee8d977196c72ad42d89d23142a6e59ff8e.patch";
      sha256 = "1vhrw6rm85wk4a28fbacjgf5xdxphbfflnnj23i4vwy6by190xbs";
    }) ];
  }));
#+END_SRC
