...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package company-shell
    ...
    :hook ((shell-mode sh-mode fish-mode eshell-mode) . (lambda ()
      (setq-local company-backends '(company-shell :with company-shell-env company-fish-shell company-capf company-files)))))
