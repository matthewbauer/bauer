...
here including running =package-initialize=, ensuring =use-package= is installed.
...
#+BEGIN_SRC nix
  ...
  myEmacs = customEmacsPackages.emacsWithPackages (epkgs:
    ...
    ++ [default epkgs.treesit-grammars.with-all-grammars]
  );
#+END_SRC
