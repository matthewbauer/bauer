...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package claude-code-ide
    ...
    (claude-code-ide-make-tool
     ...
     :args nil)
    (defun claude-ghci-compilation-add (module)
      (claude-code-ide-mcp-server-with-session-context nil
        (ghci-compilation--send-string (format ":add %s" module))))
    (claude-code-ide-make-tool
     :function #'claude-ghci-compilation-add
     :name "ghci-compilation-add"
     :description "Add Haskell module to scope. Run after first making changes to a module."
     :args '((:name "module"
                    :type string
                    :description "The module name to add to scope")))
    ...
    (defun claude-ghci-compilation-check-output ()
      (claude-code-ide-mcp-server-with-session-context nil
        (ghci-compilation-get-last-output)))
    (claude-code-ide-make-tool
...
#+BEGIN_SRC emacs-lisp
  (use-package dumb-jump
    ...
    :config
    (defun my-dumb-jump-get-language-from-aliases (lang)
    ...
    (advice-add #'dumb-jump-get-language-from-aliases :override #'my-dumb-jump-get-language-from-aliases))
#+END_SRC
