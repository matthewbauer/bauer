 ...
 '(haskell-mode-hook
   (quote
    (capitalized-words-mode flyspell-prog-mode
     haskell-indentation-mode imenu-add-menubar-index interactive-haskell-mode
...
(use-package dired-du
  ...
  ;; :init (add-hook 'dired-mode-hook #'dired-du-mode)
  )
      #+END_SRC
...
***** haskell-mode
      ...
      #+BEGIN_SRC emacs-lisp
(use-package haskell-interactive-mode :demand)
(use-package haskell-process :demand)
...
substituteInPlace $out/etc/profile.d/my-profile.sh \
  ...
  --replace @cacert@ ${cacert}
    ...
    ++ [stack ghc haskellPackages.ghc-mod];
};
   #+END_SRC
