...
#+SUBTITLE: Bauer’s automated Emacs realm
...
#+STARTUP: showall hideblocks indent align entitiespretty
...
ESUP provides good info on what is taking a long time during startup. ESUP
is a startup profiler for Emacs. I’ve provided "profile" so that you can
just profile what is in "default.el" (this script) and not any other
miscellaneous scripts you have around.
...
(use-package org
  ...
  :ensure nil
  :hook (message-mode . turn-on-orgstruct++-mode)
