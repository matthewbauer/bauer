...
(set-defaults
 ...
 '(company-backends '(company-elisp
		      ...
		      (company-files
		       ...
		       company-dabbrev-code company-ispell)
		      ))
...
(defun user-customize ()
  "Provides an easy way for users to setup their config. Run this
to input your personal settings."
  (interactive)
...
(bind-keys ("C-c C-u" . rename-uniquely)
	   ...
	   ("C-v"            . find-variable help-map)
	   ("C-k"            . find-function-on-key help-map)
	   ("C-f"            . find-function help-map)
	   ("C-l"            . find-library  help-map)
	   ...
	   ("n"              . next-line     view-mode-map)
	   ("p"              . previous-line view-mode-map)
	   ("j"              . next-line     view-mode-map)
	   ("k"              . previous-line view-mode-map)
	   ("l"              . forward-char  view-mode-map)
	   ("f"              . forward-char  view-mode-map)
	   ("b"              . backward-char view-mode-map)

	   ("C-M--" . (lambda () (interactive) (update-font-size -1)))
	   ("C-M-=" . (lambda () (interactive) (update-font-size 1)))
...
(use-package readline-complete
  ...
  :preface
  (defun no-company-mode () (company-mode -1))
  :hook (rlc-no-readline . no-company-mode)
...
(use-package company-jedi
  ...
  :hook (python-mode . setup-company-jedi)
  :preface
  (defun setup-company-jedi ()
...
(use-package company-web
  ...
  (autoload company-web-jade "company-web-html")
  (autoload company-web-slim "company-web-html")
  ...
  (defun setup-company-math ()
    (setq-local company-backends
		(append '((company-math-symbols-latex company-latex-commands))
			company-backends)))
  :hook (TeX-mode . setup-company-math))
     #+END_SRC
**** delight
...
(use-package esh-autosuggest
  ...
  :disabled
  :init
  (add-to-list 'company-backends '(esh-autosuggest :with company-capf company-files)))
#+END_SRC
...
certain Emacs keybinds.cs-lisp
...
(use-package hippie-exp
  ...
  :hook ((emacs-lisp-mode ielm-mode) . hippie-expand-allow-lisp-symbols)
  :preface
...
(use-package haskell-doc
  ...
  :hook (haskell-mode . haskell-eldoc-setup)
  :preface
  (defun haskell-eldoc-setup ()
