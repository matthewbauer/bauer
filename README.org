...
#+BEGIN_SRC emacs-lisp
  (use-package eglot
    :ensure nil
    :config
    (setq eglot-ignored-server-capabilities '(:codeLensProvider :documentFormattingProvider :documentRangeFormattingProvider :documentLinkProvider :colorProvider))
...
#+BEGIN_SRC emacs-lisp
    (use-package lsp-haskell
      ...
      :config (setq lsp-haskell-diagnostics-on-change nil))
#+END_SRC
...
#+BEGIN_SRC nix
  ...
  in pkgs'.emacsPackagesFor (pkgs'.emacsGit.overrideAttrs (o: {
