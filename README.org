...
#+BEGIN_SRC nix
  emacs-overlays = pkgs.fetchFromGitHub {
    owner = "nix-community";
    repo = "emacs-overlay";
    rev = "bfb416da4b3419a1a7d2766187b5fd52cae905c8";
    sha256 = "sha256-3OLrp7cWcrfe1+qDBuzSdcHOTsB+z2KD0WE1ldlD79s=";
  };

  emacs = (pkgs.emacs.override { srcRepo = true; }).overrideAttrs (o: {
  ...
  customEmacsPackages = (import emacs-overlays pkgs pkgs).emacsPackagesFor emacs;
#+END_SRC
