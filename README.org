...
(use-package claude-code-ide
  ...
  (defun claude-ghci-compilation-reload ()
    (claude-code-ide-mcp-server-with-session-context nil
      (ghci-compilation--send-string ":r" t)))
  ...
  (defun claude-ghci-compilation-add (modules)
    (claude-code-ide-mcp-server-with-session-context nil
      (ghci-compilation--send-string (format ":add %s" (string-join modules " ")) t)))
  (claude-code-ide-make-tool
  ...
  (defun claude-ghci-compilation-set-env (name value)
    (claude-code-ide-mcp-server-with-session-context nil
      (ghci-compilation--send-string (format ":env %s %s" name value) t)))
  (claude-code-ide-make-tool
  ...
  (defun claude-ghci-compilation-run-ghci-script (script)
    (claude-code-ide-mcp-server-with-session-context nil
      (ghci-compilation--send-string (format ":script %s" script) t)))
  (claude-code-ide-make-tool
   :function #'claude-ghci-compilation-run-tests
...
#+BEGIN_SRC nix
    ...
    install -D ${ensure ./site-lisp/agent-shell-attention.el
                         "site-lisp/agent-shell-attention.el"} \
            $out/share/emacs/site-lisp/agent-shell-attention.el
  '';
#+END_SRC
