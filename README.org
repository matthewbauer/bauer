...
#+BEGIN_SRC emacs-lisp
  (use-package eglot
    ...
    (add-to-list 'eglot-server-programs
                 `((haskell-mode haskell-ts-mode) . ,(eglot-alternatives '(("static-ls") ("haskell-language-server-wrapper" "--lsp"))))))
#+END_SRC
...
(use-package claude-code-ide
  ...
  (defun claude-ghci-compilation-add (modules)
    (claude-code-ide-mcp-server-with-session-context nil
      (ghci-compilation--send-string (format ":add %s" (string-join modules " ")))))
  (claude-code-ide-make-tool
  ...
  (defun claude-ghci-compilation-set-env (name value)
    (claude-code-ide-mcp-server-with-session-context nil
      (ghci-compilation--send-string (format ":env %s %s" name value))))
  (claude-code-ide-make-tool
  ...
  (defun claude-ghci-compilation-run-ghci-script (script)
    (claude-code-ide-mcp-server-with-session-context nil
      (ghci-compilation--send-string (format ":script %s" script))))
  (claude-code-ide-make-tool
   :function #'claude-ghci-compilation-run-tests
  ...
  (defun claude-ghci-compilation-rerun-last-command ()
    (claude-code-ide-mcp-server-with-session-context nil
      (ghci-compilation--send-string (with-current-buffer (ghci-compilation-get-buffer nil) (comint-previous-input-string 0)))))
  (claude-code-ide-make-tool
