...
(bind-key "C-v"           'find-variable help-map)
(bind-key "C-k"           'find-function-on-key help-map)
(bind-key "C-f"           'find-function help-map)
(bind-key "C-l"           'find-library  help-map)

(bind-key "C-x M-p" (lambda () (interactive) (save-excursion (other-window 1)
							(quit-window))))
...
(defun spec-to-list (spec) (s-split "-" spec))

(defun list-to-spec (spec) (s-join "-" spec))
...
(bind-key "C-M--" (lambda () (interactive) (update-font-size -1)))
(bind-key "C-M-=" (lambda () (interactive) (update-font-size 1)))
