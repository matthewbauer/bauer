...
#+BEGIN_SRC emacs-lisp
    ...
    (use-package minuet
      :bind
      (;; ("C-c m" . minuet-complete-with-minibuffer) ;; use minibuffer for completion
       ;; ("M-ai" . minuet-show-suggestion) ;; use overlay for completion
      ...
      (plist-put minuet-openai-fim-compatible-options :model "gemma-3-1b")
...
(use-package agent-shell
  :custom (agent-shell-anthropic-authentication (agent-shell-anthropic-make-authentication :login t)))
#+END_SRC
