...
#+BEGIN_SRC nix
  ...
  install -D ${./site-lisp/em-dired.el} $out/share/emacs/site-lisp/em-dired.el
  install -D ${./site-lisp/dired-column.el} \
    $out/share/emacs/site-lisp/dired-column.el
  install -D ${./site-lisp/macho-mode.el} $out/share/emacs/site-lisp/macho-mode.el
  install -D ${./site-lisp/nethack.el} $out/share/emacs/site-lisp/nethack.el
  install -D ${./site-lisp/set-defaults.el} \
    $out/share/emacs/site-lisp/set-defaults.el
  install -D ${./site-lisp/installer.el} $out/share/emacs/site-lisp/installer.el
  install -D ${./site-lisp/restart-emacs.el} \
    $out/share/emacs/site-lisp/restart-emacs.el
  install -D ${./site-lisp/use-package-list.el} \
    $out/share/emacs/site-lisp/use-package-list.el
  install -D ${./site-lisp/bauer.el} \
...
#+BEGIN_SRC nix
  userPackages = [
    ...
    # Useful tools
    wget cacert isync notmuch graphviz indent
