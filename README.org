...
* bauer
  ...
  @[[https://matthewbauer.us][matthewbauer]]’s Emacs config: An [[https://www.gnu.org/s/emacs/][Emacs]]+[[https://nixos.org][Nix]] IDE
...
** Packages
 ...
 - which-key (3)
   ...
   To resort, go to ‘All packages’ heading and type C-c ^ (the shortcut for
   org-sort).
...
**** jka-compr
     ...
     Add some binary plist decompression.
