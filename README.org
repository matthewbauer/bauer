...
#+BEGIN_SRC emacs-lisp
  (set-defaults
   ...
   '(counsel-linux-apps-directories '("~/.nix-profile/share/applications/"
   ...
   ;; '(eshell-postoutput-scroll-to-bottom t)
...
#+BEGIN_SRC emacs-lisp
  (use-package shell
    ...
    :hook ((shell-mode . ansi-color-for-comint-mode-on)
           ...
           (shell-mode . (lambda ()
                      (setq-local comint-input-ring-file-name "~/.history")
...
#+BEGIN_SRC nix
  ...
  install -D ${ensure ./site-lisp/nix-haskell.el
                      "site-lisp/nix-haskell.el"} \
          $out/share/emacs/site-lisp/nix-haskell.el
...
#+BEGIN_SRC nix
  myEmacsPackages = buildEnv {
    ...
    paths = (requiredPackages pkgs.emacsPackagesNg myEmacsPackages')
          ++ [ pkgs.emacsPackagesNg.use-package ];
  };
