...
(require 'site-paths nil t)
   ...
   site-paths.el is basically just setting different /paths/ will be generated by Nix. In
   this way, we don’t need to ask the user to install any external software.
   That is, this Emacs distribution is self-contained.
