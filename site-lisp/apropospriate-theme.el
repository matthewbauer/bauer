...
(defun create-apropospriate-theme (variant theme-name)
  ...
  (apropospriate-with-color-variables variant
				      (custom-theme-set-faces
				       ...
				       `(ediff-current-diff-A ((,class (:foreground ,red :background ,base00-2 :stipple nil :extend t))))
				       `(ediff-current-diff-Ancestor ((,class (:inherit ediff-current-diff-A))))
				       `(ediff-current-diff-B ((,class (:foreground ,green :background ,base00-2 :stipple nil :extend t))))
				       `(ediff-current-diff-C ((,class (:foreground ,yellow :background ,base00-2 :stipple nil :extend t))))
				       `(ediff-fine-diff-A ((,class (:background ,red :stipple nil :extend t))))
				       `(ediff-fine-diff-Ancestor ((,class (:inherit ediff-fine-diff-A))))
				       `(ediff-fine-diff-B ((,class (:background ,green :stipple nil :extend t))))
				       `(ediff-fine-diff-C ((,class (:background ,yellow :stipple nil :extend t))))
