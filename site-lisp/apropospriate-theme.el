...
(defmacro apropospriate-with-color-variables (variant &rest body)
  ...
  `(let* ((class '((class color) (min-colors 89)))
          ...
          (highlight-line-color (if (eq variant 'light) "#EEEEEE" "#555555")))
     ,@body))
...
(defun create-apropospriate-theme (variant theme-name)
  ...
  (apropospriate-with-color-variables variant
				      (custom-theme-set-faces
				       ...
				       `(mode-line ((,class (:box (:line-width 2 :color ,light-emphasis :style nil)
								  :background ,base00-2 :foreground ,base03
								  :height ,(or apropospriate-mode-line-height 1.0)))))
				       `(mode-line-inactive ((,class (:box (:line-width 2 :color ,base00+1 :style nil)
				       ...
				       `(tabbar-default ((,class (:inherit default :foreground ,base02 :background "black" :box (:line-width 2 :color ,base00 :style nil)))))
				       `(tabbar-button ((,class (:height 0.8 :box (:line-width 2 :color ,base00-2 :style nil)))))
				       `(tabbar-unselected ((,class (:inherit tabbar-button :background ,base00-2))))
				       `(tabbar-modified ((,class (:inherit tabbar-unselected))))
				       `(tabbar-selected ((,class (:inherit tabbar-button :box (:line-width 2 :color ,base00 :style nil)))))
				       ...
				       `(tab-line-tab ((,class (:foreground ,base02 :background ,base00-2 :box (:line-width 2 :color ,base00-2 :style nil)))))
				       `(tab-line-tab-inactive ((,class (:foreground ,base02 :background ,base00-2 :box (:line-width 2 :color ,base00-2 :style nil) :inverse-video nil))))
				       `(tab-line-tab-inactive-alternate ((,class (:background ,base00-2))))
				       `(tab-line-tab-current ((,class (:foreground ,base03 :background ,base00 :box (:line-width 2 :color ,base00 :style nil)))))
				       `(tab-line-highlight ((,class (:background ,highlight-line-color :box (:line-width 2 :color ,highlight-line-color :style nil)))))
				       `(tab-line-close-highlight ((,class (:color ,red))))
				       `(tab-bar-tab ((,class (:background ,base00 :box (:line-width 2 :color ,base00 :style nil)))))
				       ...
				       `(ediff-current-diff-A ((,class (:foreground ,red :background ,base00-2))))
				       `(ediff-current-diff-Ancestor ((,class (:inherit ediff-current-diff-A))))
				       `(ediff-current-diff-B ((,class (:foreground ,green :background ,base00-2))))
				       `(ediff-current-diff-C ((,class (:foreground ,yellow :background ,base00-2))))
				       `(ediff-fine-diff-A ((,class (:background ,red))))
				       `(ediff-fine-diff-Ancestor ((,class (:inherit ediff-fine-diff-A))))
				       `(ediff-fine-diff-B ((,class (:background ,green))))
				       `(ediff-fine-diff-C ((,class (:background ,yellow))))
				       `(ediff-even-diff-A ((,class (:background ,base00+1))))
				       ...
				       `(ansi-color-white ((,class (:foreground ,base03))))
				       `(ansi-color-bright-white ((,class (:foreground ,base03))))
				       `(term ((,class (:foreground ,base03))))
				       `(term-color-black ((,class (:foreground ,base03))))
				       `(term-color-bright-black ((,class (:foreground ,base03))))
				       `(term-color-red ((,class (:foreground ,red))))
				       `(term-color-bright-red ((,class (:foreground ,red-1))))
				       `(term-color-green ((,class (:foreground ,green))))
				       `(term-color-bright-green ((,class (:foreground ,green-1))))
				       `(term-color-yellow ((,class (:foreground ,yellow))))
				       `(term-color-bright-yellow ((,class (:foreground ,yellow-1))))
				       `(term-color-blue ((,class (:foreground ,blue))))
				       `(term-color-bright-blue ((,class (:foreground ,blue-1))))
				       `(term-color-magenta ((,class (:foreground ,purple))))
				       `(term-color-bright-magenta ((,class (:foreground ,purple-1))))
				       `(term-color-cyan ((,class (:foreground ,cyan))))
				       `(term-color-bright-cyan ((,class (:foreground ,cyan-1))))
				       `(term-color-white ((,class (:foreground ,base03))))
				       `(term-color-bright-white ((,class (:foreground ,base03))))
