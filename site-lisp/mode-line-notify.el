...
(defun mode-line-notify-indicator ()
                                                       ...
                                                       (when mode-line-notify--data
                                                         (let ((action (plist-get (car mode-line-notify--data) :action)))
                                                           ...
                                                           (when action
                                                             (funcall action))))))
                                         map)))))
  "Mode line indicator for notifications.")
...
(define-minor-mode mode-line-notify
  ...
  (if mode-line-notify
      (setq-default mode-line-misc-info
                    (push '("" mode-line-notify-info) mode-line-misc-info))
    (setq-default mode-line-misc-info
                  (delete '("" mode-line-notify-info) mode-line-misc-info))))
